...
class TestOstoskori(unittest.TestCase):
    ...
    def test_kahden_eri_tuotteen_lisäämisen_jalkeen_ostoskorin_hinta_on_sama_kuin_tuotteiden_hintojen_summa(self):
        maito = Tuote("Maito", 3)
        juusto = Tuote("Juusto", 5)
        self.kori.lisaa_tuote(maito)
        self.kori.lisaa_tuote(juusto)
    ...
    def test_yhden_tuotteen_lisaamisen_jalkeen_ostoskori_sisaltaa_yhden_ostoksen(self):
        ...
        ostosten_maara = len(ostokset)
        self.assertEqual(ostosten_maara, 1)

    def test_yhden_tuotteen_lisaamisen_jalkeen_ostoskori_sisaltaa_yhden_ostoksen_jolla_on_sama_nimi_kuin_tuotteella_ja_lukumaara_1(self):
        maito = Tuote("Maito", 3)
        self.kori.lisaa_tuote(maito)
    ...
    def test_kahden_eri_tuotteen_lisaamisen_jalkeen_ostoskori_sisaltaa_kaksi_ostosta(self):
        ...
        ostosten_maara = len(ostokset)
        self.assertEqual(ostosten_maara, 2)
    ...
    def test_kahden_saman_tuotteen_lisaamisen_jalkeen_ostoskori_sisaltaa_ostoksen_jolla_sama_nimi_kuin_tuotteella_ja_lukumaara_2(self):
        ...
        self.assertEqual(2, ostos.lukumaara())
    ...
    def test_jos_korissa_on_kaksi_samaa_tuotetta_ja_toinen_naista_poistetaan_jaa_koriin_ostos_jossa_on_tuotetta_1_kpl(self):
        ...
        self.ostos = self.kori.ostokset()[0]
        
        self.assertEqual(self.ostos.lukumaara(), 1)

    def test_jos_koriin_lisatty_tuote_ja_sama_tuote_poistetaan_on_kori_taman_jalkeen_tyhja(self):
        maito = Tuote("Maito", 3)
        self.kori.lisaa_tuote(maito)
        self.kori.poista_tuote(maito)
